...
CREATE TABLE Car (
    Car_number VARCHAR(20) UNIQUE PRIMARY KEY,
...
CREATE TABLE Car_parking (
    ...
    PRIMARY KEY (Parking_spot_ID, Car_number, Start_time)
);

INSERT INTO People (Name, Passport, Job) VALUES
('Арина Леонтьева', 123456, 'Предприниматель'),
('Рогович Маша', 654321, 'Инструктор по дайвингу'),
...
$$
    ...
    ELSIF TG_OP = 'DELETE' THEN
        ...
        WHERE Parking_spot_ID = OLD.Parking_spot_ID;
    END IF;
...
CREATE TRIGGER trg_update_parking_status
AFTER INSERT OR DELETE ON Car_Parking
FOR EACH ROW
