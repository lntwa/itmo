...
public class AddIfMax extends Command {
     ...
     */
    public AddIfMax(Console console, CollectionManager collectionManager, DBmanager dbmanager) {
        ...
        commandType = CommandTypes.AddIfMax;
    }
    ...
    public ExecutionResponse apply(String[] arguments, String login) {
        try {
            ...
            if (collectionManager.getFirst().getPopulation() > city.getPopulation()) {
                return new ExecutionResponse(false, "Население введенного города меньше чем значение из коллекции с максимальным значением населения! ");
            }
