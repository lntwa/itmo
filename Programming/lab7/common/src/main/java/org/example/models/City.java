 ...
 * @version 1.0
 */
public class City implements Comparable<City>, Validatable, Serializable {
    /**
    ...
    public City(int id, String name, Coordinates coordinates, LocalDate creationDate, Double area, Integer population,
                long metersAboveSeaLevel, Double timezone, Float populationDensity, StandardOfLiving standardOfLiving, String owner, Human governor) {
        this.id = id;
        this.name = name;
    ...
    public static City fromArray(String[] data, String owner) {
        try {
            ...
            return new City(id, name, coordinates, creationDate, area, population, metersAboveSeaLevel, timezone, populationDensity, standardOfLiving,owner, human);
        } catch (Exception e) {
            return null;
        }
    }
