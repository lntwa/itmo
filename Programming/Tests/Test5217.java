...
public class Test5217 {
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.Vector<LabWork> collection = (java.util.Vector<LabWork>) field.get(classWithCollection.newInstance());
    ...
    private static void checkCorrectElementInCollection(LabWork element) {
        assertAll(
		() -> assertEquals("hDZcUQfMXK", element.getName()),
		() -> assertEquals(Integer.parseInteger("-412"), element.getCoordinates().getX()),
		() -> assertEquals(Long.parseLong("-332"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInt("363"), element.getMinimalPoint()),
		() -> assertEquals("qIFGVJgVlp", element.getDescription()),
		() -> assertEquals(Difficulty.VERY_HARD, element.getDifficulty()),
 		() -> assertEquals("NnVQQpCzVc", element.getAuthor().getName()),
		() -> assertEquals(Float.parseFloat("812"), element.getAuthor().getHeight()),
		() -> assertEquals(Country.CHINA, element.getAuthor().getNationality())
        );
    }

    private static void checkUpdateCorrectElementInCollection(LabWork element) {
        assertAll(
		() -> assertEquals("hDZcUQfMXKUpd", element.getName()),
		() -> assertEquals(Integer.parseInteger("-412"), element.getCoordinates().getX()),
		() -> assertEquals(Long.parseLong("-332"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInt("363"), element.getMinimalPoint()),
		() -> assertEquals("qIFGVJgVlpUpd", element.getDescription()),
		() -> assertEquals(Difficulty.VERY_HARD, element.getDifficulty()),
 		() -> assertEquals("NnVQQpCzVcUpd", element.getAuthor().getName()),
		() -> assertEquals(Float.parseFloat("812"), element.getAuthor().getHeight()),
		() -> assertEquals(Country.CHINA, element.getAuthor().getNationality())
        );
    }
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("hDZcUQfMXK").append('\n');
		sb.append(Integer.parseInteger("-412")).append('\n');
		sb.append(Long.parseLong("-332")).append('\n');
		sb.append(Integer.parseInt("363")).append('\n');
		sb.append("qIFGVJgVlp").append('\n');
		sb.append("VERY_HARD").append('\n');
		sb.append("NnVQQpCzVc").append('\n');
		sb.append(Float.parseFloat("812")).append('\n');
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("hDZcUQfMXKUpd").append('\n');
		sb.append(Integer.parseInteger("-412")).append('\n');
		sb.append(Long.parseLong("-332")).append('\n');
		sb.append(Integer.parseInt("363")).append('\n');
		sb.append("qIFGVJgVlpUpd").append('\n');
		sb.append("VERY_HARD").append('\n');
		sb.append("NnVQQpCzVcUpd").append('\n');
		sb.append(Float.parseFloat("812")).append('\n');
		sb.append("CHINA").append('\n');
        return sb;
    }
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				...
				Arguments.of("LabWork", "minimalPoint", "int"),
				Arguments.of("LabWork", "description", "String"),
				Arguments.of("LabWork", "difficulty", "Difficulty"),
				Arguments.of("LabWork", "author", "Person"),
				Arguments.of("Coordinates", "x", "Integer"),
				Arguments.of("Coordinates", "y", "Long"),
				Arguments.of("Person", "name", "String"),
				Arguments.of("Person", "birthday", "java.time.LocalDate"),
				Arguments.of("Person", "height", "Float"),
