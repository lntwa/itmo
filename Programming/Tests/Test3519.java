...
public class Test3519 {
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.LinkedHashSet<LabWork> collection = (java.util.LinkedHashSet<LabWork>) field.get(classWithCollection.newInstance());
    ...
    private static void checkCorrectElementInCollection(LabWork element) {
        assertAll(
		() -> assertEquals("EEZrYGxjux", element.getName()),
		() -> assertEquals(Integer.parseInt("-669"), element.getCoordinates().getX()),
		() -> assertEquals(Double.parseDouble("731"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInt("561"), element.getMinimalPoint()),
		() -> assertEquals(Difficulty.NORMAL, element.getDifficulty()),
 		() -> assertEquals("epuleFQlRF", element.getAuthor().getName()),
		() -> assertEquals(Float.parseFloat("480"), element.getAuthor().getHeight()),
		() -> assertEquals(Color.BLACK, element.getAuthor().getEyeColor()),
		() -> assertEquals(Color.BLACK, element.getAuthor().getHairColor()),
		() -> assertEquals(Country.THAILAND, element.getAuthor().getNationality())
        );
    }

    private static void checkUpdateCorrectElementInCollection(LabWork element) {
        assertAll(
		() -> assertEquals("EEZrYGxjuxUpd", element.getName()),
		() -> assertEquals(Integer.parseInt("-669"), element.getCoordinates().getX()),
		() -> assertEquals(Double.parseDouble("731"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInt("561"), element.getMinimalPoint()),
		() -> assertEquals(Difficulty.NORMAL, element.getDifficulty()),
 		() -> assertEquals("epuleFQlRFUpd", element.getAuthor().getName()),
		() -> assertEquals(Float.parseFloat("480"), element.getAuthor().getHeight()),
		() -> assertEquals(Color.BLACK, element.getAuthor().getEyeColor()),
		() -> assertEquals(Color.BLACK, element.getAuthor().getHairColor()),
		() -> assertEquals(Country.THAILAND, element.getAuthor().getNationality())
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("EEZrYGxjux").append('\n');
		sb.append(Integer.parseInt("-669")).append('\n');
		sb.append(Double.parseDouble("731")).append('\n');
		sb.append(Integer.parseInt("561")).append('\n');
		sb.append("NORMAL").append('\n');
		sb.append("epuleFQlRF").append('\n');
		sb.append(Float.parseFloat("480")).append('\n');
		sb.append("BLACK").append('\n');
		sb.append("BLACK").append('\n');
		sb.append("THAILAND").append('\n');
        return sb;
    }
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("EEZrYGxjuxUpd").append('\n');
		sb.append(Integer.parseInt("-669")).append('\n');
		sb.append(Double.parseDouble("731")).append('\n');
		sb.append(Integer.parseInt("561")).append('\n');
		sb.append("NORMAL").append('\n');
		sb.append("epuleFQlRFUpd").append('\n');
		sb.append(Float.parseFloat("480")).append('\n');
		sb.append("BLACK").append('\n');
		sb.append("BLACK").append('\n');
		sb.append("THAILAND").append('\n');
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				Arguments.of("LabWork", "id", "Integer"),
				Arguments.of("LabWork", "name", "String"),
				Arguments.of("LabWork", "coordinates", "Coordinates"),
				Arguments.of("LabWork", "creationDate", "java.util.Date"),
				...
				Arguments.of("Person", "eyeColor", "Color"),
