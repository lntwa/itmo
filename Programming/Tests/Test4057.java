...
public class Test4057 {
    ...
    private final Class<java.util.HashSet> STUDENT_COLLECTION_NAME = java.util.HashSet.class;
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.HashSet<MusicBand> collection = (java.util.HashSet<MusicBand>) field.get(classWithCollection.newInstance());
    ...
    private static void checkCorrectElementInCollection(MusicBand element) {
        assertAll(
		() -> assertEquals("TZiocufSKf", element.getName()),
		() -> assertEquals(Float.parseFloat("-957"), element.getCoordinates().getX()),
		() -> assertEquals(Long.parseLong("-204"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInteger("68"), element.getNumberOfParticipants()),
		() -> assertEquals(Integer.parseInteger("403"), element.getAlbumsCount()),
		() -> assertEquals("aFmJnphehR", element.getDescription()),
		() -> assertEquals(MusicGenre.PSYCHEDELIC_ROCK, element.getGenre()),
 		() -> assertEquals("OygEJTWqob", element.getFrontMan().getName()),
		() -> assertEquals(Double.parseDouble("487"), element.getFrontMan().getHeight()),
		() -> assertEquals(Double.parseDouble("560"), element.getFrontMan().getWeight()),
		() -> assertEquals(Color.WHITE, element.getFrontMan().getHairColor()),
		() -> assertEquals(Country.INDIA, element.getFrontMan().getNationality())
        );
    }

    private static void checkUpdateCorrectElementInCollection(MusicBand element) {
        assertAll(
		() -> assertEquals("TZiocufSKfUpd", element.getName()),
		() -> assertEquals(Float.parseFloat("-957"), element.getCoordinates().getX()),
		() -> assertEquals(Long.parseLong("-204"), element.getCoordinates().getY()),
		() -> assertEquals(Integer.parseInteger("68"), element.getNumberOfParticipants()),
		() -> assertEquals(Integer.parseInteger("403"), element.getAlbumsCount()),
		() -> assertEquals("aFmJnphehRUpd", element.getDescription()),
		() -> assertEquals(MusicGenre.PSYCHEDELIC_ROCK, element.getGenre()),
 		() -> assertEquals("OygEJTWqobUpd", element.getFrontMan().getName()),
		() -> assertEquals(Double.parseDouble("487"), element.getFrontMan().getHeight()),
		() -> assertEquals(Double.parseDouble("560"), element.getFrontMan().getWeight()),
		() -> assertEquals(Color.WHITE, element.getFrontMan().getHairColor()),
		() -> assertEquals(Country.INDIA, element.getFrontMan().getNationality())
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("TZiocufSKf").append('\n');
		sb.append(Float.parseFloat("-957")).append('\n');
		sb.append(Long.parseLong("-204")).append('\n');
		sb.append(Integer.parseInteger("68")).append('\n');
		sb.append(Integer.parseInteger("403")).append('\n');
		sb.append("aFmJnphehR").append('\n');
		sb.append("PSYCHEDELIC_ROCK").append('\n');
		sb.append("OygEJTWqob").append('\n');
		sb.append(Double.parseDouble("487")).append('\n');
		sb.append(Double.parseDouble("560")).append('\n');
		sb.append("WHITE").append('\n');
		sb.append("INDIA").append('\n');
        return sb;
    }
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("TZiocufSKfUpd").append('\n');
		sb.append(Float.parseFloat("-957")).append('\n');
		sb.append(Long.parseLong("-204")).append('\n');
		sb.append(Integer.parseInteger("68")).append('\n');
		sb.append(Integer.parseInteger("403")).append('\n');
		sb.append("aFmJnphehRUpd").append('\n');
		sb.append("PSYCHEDELIC_ROCK").append('\n');
		sb.append("OygEJTWqobUpd").append('\n');
		sb.append(Double.parseDouble("487")).append('\n');
		sb.append(Double.parseDouble("560")).append('\n');
		sb.append("WHITE").append('\n');
		sb.append("INDIA").append('\n');
    ...
    private Field getFieldWithRequiredType(Class cl) {
        Class<?> myType = java.util.HashSet.class;
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				Arguments.of("MusicBand", "id", "int"),
				Arguments.of("MusicBand", "name", "String"),
				Arguments.of("MusicBand", "coordinates", "Coordinates"),
				Arguments.of("MusicBand", "creationDate", "java.time.LocalDate"),
				Arguments.of("MusicBand", "numberOfParticipants", "Integer"),
				Arguments.of("MusicBand", "albumsCount", "Integer"),
				Arguments.of("MusicBand", "description", "String"),
				Arguments.of("MusicBand", "genre", "MusicGenre"),
				Arguments.of("MusicBand", "frontMan", "Person"),
				...
				Arguments.of("Person", "hairColor", "Color"),
