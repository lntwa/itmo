...
public class Test4262 {
    ...
    private final String STUDENT_CLASS_NAME = "Product";
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.LinkedList<Product> collection = (java.util.LinkedList<Product>) field.get(classWithCollection.newInstance());
            assertEquals(1, collection.size(), "Добавление работает некорректно");
            Product element = collection.stream().findFirst().get();
    ...
    private static void checkCorrectElementInCollection(Product element) {
        assertAll(
		() -> assertEquals("snDEEXNBgz", element.getName()),
		() -> assertEquals(Float.parseFloat("-407"), element.getCoordinates().getX()),
		() -> assertEquals(Integer.parseInteger("-516"), element.getCoordinates().getY()),
		() -> assertEquals(Float.parseFloat("898"), element.getPrice()),
		() -> assertEquals(Integer.parseInt("814"), element.getManufactureCost()),
		() -> assertEquals(UnitOfMeasure.CENTIMETERS, element.getUnitOfMeasure()),
 		() -> assertEquals(Long.parseLong("445"), element.getManufacturer().getId()),
		() -> assertEquals("gqMyaCUdwi", element.getManufacturer().getName()),
		() -> assertEquals("MOdKKIOaFi", element.getManufacturer().getFullName()),
		() -> assertEquals(OrganizationType.COMMERCIAL, element.getManufacturer().getType())
        );
    }

    private static void checkUpdateCorrectElementInCollection(Product element) {
        assertAll(
		() -> assertEquals("snDEEXNBgzUpd", element.getName()),
		() -> assertEquals(Float.parseFloat("-407"), element.getCoordinates().getX()),
		() -> assertEquals(Integer.parseInteger("-516"), element.getCoordinates().getY()),
		() -> assertEquals(Float.parseFloat("898"), element.getPrice()),
		() -> assertEquals(Integer.parseInt("814"), element.getManufactureCost()),
		() -> assertEquals(UnitOfMeasure.CENTIMETERS, element.getUnitOfMeasure()),
 		() -> assertEquals(Long.parseLong("445"), element.getManufacturer().getId()),
		() -> assertEquals("gqMyaCUdwiUpd", element.getManufacturer().getName()),
		() -> assertEquals("MOdKKIOaFiUpd", element.getManufacturer().getFullName()),
		() -> assertEquals(OrganizationType.COMMERCIAL, element.getManufacturer().getType())
        );
    }
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("snDEEXNBgz").append('\n');
		sb.append(Float.parseFloat("-407")).append('\n');
		sb.append(Integer.parseInteger("-516")).append('\n');
		sb.append(Float.parseFloat("898")).append('\n');
		sb.append(Integer.parseInt("814")).append('\n');
		sb.append("CENTIMETERS").append('\n');
		sb.append(Long.parseLong("445")).append('\n');
		sb.append("gqMyaCUdwi").append('\n');
		sb.append("MOdKKIOaFi").append('\n');
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("snDEEXNBgzUpd").append('\n');
		sb.append(Float.parseFloat("-407")).append('\n');
		sb.append(Integer.parseInteger("-516")).append('\n');
		sb.append(Float.parseFloat("898")).append('\n');
		sb.append(Integer.parseInt("814")).append('\n');
		sb.append("CENTIMETERS").append('\n');
		sb.append(Long.parseLong("445")).append('\n');
		sb.append("gqMyaCUdwiUpd").append('\n');
		sb.append("MOdKKIOaFiUpd").append('\n');
		sb.append("COMMERCIAL").append('\n');
        return sb;
    }
    ...
    private static StringBuilder getRestrictionsAddCommandArguments() {
		...
		sb.append('\n').append('\n');
		sb.append("snDEEXNBgz").append('\n');
		sb.append("943").append('\n');
		sb.append('\n').append('\n');
		sb.append(Float.parseFloat("-407")).append('\n');
		sb.append("486").append('\n');
		sb.append('\n').append('\n');
		sb.append(Integer.parseInteger("-516")).append('\n');
		sb.append("-1").append('\n');
		sb.append(Float.parseFloat("898")).append('\n');
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				Arguments.of("Product", "id", "Integer"),
				Arguments.of("Product", "name", "String"),
				Arguments.of("Product", "coordinates", "Coordinates"),
				Arguments.of("Product", "creationDate", "java.util.Date"),
				Arguments.of("Product", "price", "Float"),
				Arguments.of("Product", "manufactureCost", "int"),
				Arguments.of("Product", "unitOfMeasure", "UnitOfMeasure"),
				Arguments.of("Product", "manufacturer", "Organization"),
				Arguments.of("Coordinates", "x", "Float"),
				Arguments.of("Coordinates", "y", "Integer"),
				Arguments.of("Organization", "id", "Long"),
				Arguments.of("Organization", "name", "String"),
