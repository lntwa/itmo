...
public class Test4845 {
    ...
    private final String STUDENT_CLASS_NAME = "HumanBeing";
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.LinkedHashSet<HumanBeing> collection = (java.util.LinkedHashSet<HumanBeing>) field.get(classWithCollection.newInstance());
            assertEquals(1, collection.size(), "Добавление работает некорректно");
            HumanBeing element = collection.stream().findFirst().get();
    ...
    private static void checkCorrectElementInCollection(HumanBeing element) {
        assertAll(
		() -> assertEquals("UgdmgWaNYZ", element.getName()),
		() -> assertEquals(Float.parseFloat("686"), element.getCoordinates().getX()),
		() -> assertEquals(Float.parseFloat("-431"), element.getCoordinates().getY()),
		() -> assertEquals("true", element.getRealHero()),
		() -> assertEquals("false", element.getHasToothpick()),
		() -> assertEquals(Long.parseLong("186"), element.getImpactSpeed()),
		() -> assertEquals("NhRLvnCfdZ", element.getSoundtrackName()),
		() -> assertEquals(Double.parseDouble("96"), element.getMinutesOfWaiting()),
		() -> assertEquals(WeaponType.PISTOL, element.getWeaponType()),
 		() -> assertEquals("SQMjLQEXLV", element.getCar().getName())
        );
    }

    private static void checkUpdateCorrectElementInCollection(HumanBeing element) {
        assertAll(
		() -> assertEquals("UgdmgWaNYZUpd", element.getName()),
		() -> assertEquals(Float.parseFloat("686"), element.getCoordinates().getX()),
		() -> assertEquals(Float.parseFloat("-431"), element.getCoordinates().getY()),
		() -> assertEquals("true", element.getRealHero()),
		() -> assertEquals("false", element.getHasToothpick()),
		() -> assertEquals(Long.parseLong("186"), element.getImpactSpeed()),
		() -> assertEquals("NhRLvnCfdZUpd", element.getSoundtrackName()),
		() -> assertEquals(Double.parseDouble("96"), element.getMinutesOfWaiting()),
		() -> assertEquals(WeaponType.PISTOL, element.getWeaponType()),
 		() -> assertEquals("SQMjLQEXLVUpd", element.getCar().getName())
        );
    }
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("UgdmgWaNYZ").append('\n');
		sb.append(Float.parseFloat("686")).append('\n');
		sb.append(Float.parseFloat("-431")).append('\n');
		sb.append("true").append('\n');
		sb.append("false").append('\n');
		sb.append(Long.parseLong("186")).append('\n');
		sb.append("NhRLvnCfdZ").append('\n');
		sb.append(Double.parseDouble("96")).append('\n');
		sb.append("PISTOL").append('\n');
		sb.append("SQMjLQEXLV").append('\n');
        return sb;
    }
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("UgdmgWaNYZUpd").append('\n');
		sb.append(Float.parseFloat("686")).append('\n');
		sb.append(Float.parseFloat("-431")).append('\n');
		sb.append("true").append('\n');
		sb.append("false").append('\n');
		sb.append(Long.parseLong("186")).append('\n');
		sb.append("NhRLvnCfdZUpd").append('\n');
		sb.append(Double.parseDouble("96")).append('\n');
		sb.append("PISTOL").append('\n');
		sb.append("SQMjLQEXLVUpd").append('\n');
        return sb;
    }
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				Arguments.of("HumanBeing", "id", "int"),
				Arguments.of("HumanBeing", "name", "String"),
				Arguments.of("HumanBeing", "coordinates", "Coordinates"),
				Arguments.of("HumanBeing", "creationDate", "java.time.LocalDateTime"),
				Arguments.of("HumanBeing", "realHero", "Boolean"),
				Arguments.of("HumanBeing", "hasToothpick", "boolean"),
				Arguments.of("HumanBeing", "impactSpeed", "Long"),
				Arguments.of("HumanBeing", "soundtrackName", "String"),
				Arguments.of("HumanBeing", "minutesOfWaiting", "double"),
				Arguments.of("HumanBeing", "weaponType", "WeaponType"),
				Arguments.of("HumanBeing", "car", "Car"),
				Arguments.of("Coordinates", "x", "float"),
				Arguments.of("Coordinates", "y", "Float"),
				Arguments.of("Car", "name", "String")
        );
    }
}
