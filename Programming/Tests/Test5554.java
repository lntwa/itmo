...
public class Test5554 {
    ...
    public void checkAddCommand() {
        assertDoesNotThrow(() -> {
            ...
            java.util.Vector<MusicBand> collection = (java.util.Vector<MusicBand>) field.get(classWithCollection.newInstance());
    ...
    private static void checkCorrectElementInCollection(MusicBand element) {
        assertAll(
		() -> assertEquals("xMlbDuXOaY", element.getName()),
		() -> assertEquals(Integer.parseInteger("-130"), element.getCoordinates().getX()),
		() -> assertEquals(Integer.parseInt("994"), element.getCoordinates().getY()),
		() -> assertEquals(Long.parseLong("693"), element.getNumberOfParticipants()),
		() -> assertEquals(Integer.parseInteger("670"), element.getAlbumsCount()),
		() -> assertEquals(MusicGenre.PUNK_ROCK, element.getGenre()),
 		() -> assertEquals(Long.parseLong("154"), element.getLabel().getSales())
        );
    }

    private static void checkUpdateCorrectElementInCollection(MusicBand element) {
        assertAll(
		() -> assertEquals("xMlbDuXOaYUpd", element.getName()),
		() -> assertEquals(Integer.parseInteger("-130"), element.getCoordinates().getX()),
		() -> assertEquals(Integer.parseInt("994"), element.getCoordinates().getY()),
		() -> assertEquals(Long.parseLong("693"), element.getNumberOfParticipants()),
		() -> assertEquals(Integer.parseInteger("670"), element.getAlbumsCount()),
    ...
    private static StringBuilder getAddCommandArguments() {
		...
		sb.append("xMlbDuXOaY").append('\n');
		sb.append(Integer.parseInteger("-130")).append('\n');
		sb.append(Integer.parseInt("994")).append('\n');
		sb.append(Long.parseLong("693")).append('\n');
		sb.append(Integer.parseInteger("670")).append('\n');
		sb.append("PUNK_ROCK").append('\n');
		sb.append(Long.parseLong("154")).append('\n');
        return sb;
    }
    ...
    private static StringBuilder getUpdateCommandArguments() {
		...
		sb.append("xMlbDuXOaYUpd").append('\n');
		sb.append(Integer.parseInteger("-130")).append('\n');
		sb.append(Integer.parseInt("994")).append('\n');
		sb.append(Long.parseLong("693")).append('\n');
		sb.append(Integer.parseInteger("670")).append('\n');
    ...
    private static StringBuilder getRestrictionsAddCommandArguments() {
		...
		sb.append('\n').append('\n');
		sb.append("xMlbDuXOaY").append('\n');
		sb.append("-391").append('\n');
		sb.append('\n').append('\n');
		sb.append(Integer.parseInteger("-130")).append('\n');
		sb.append("-372").append('\n');
		sb.append(Integer.parseInt("994")).append('\n');
		sb.append("-1").append('\n');
		sb.append(Long.parseLong("693")).append('\n');
		sb.append("-1").append('\n');
    ...
    private static Stream<Arguments> getFieldsWithTypes() {
        return Stream.of(
				...
				Arguments.of("MusicBand", "creationDate", "java.time.LocalDateTime"),
				Arguments.of("MusicBand", "numberOfParticipants", "long"),
