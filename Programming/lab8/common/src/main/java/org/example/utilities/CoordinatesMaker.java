...
public final class CoordinatesMaker {
     ...
     */
    public static Double parseX(BasicUserIO io) throws InvalidFieldException {
        Double x = BasicParsers.parseDouble(
                io,
                "X: ",
                "Error."
        );
     ...
     * @throws InvalidFieldException если введенное значение некорректно
     */
    public static Long parseY(BasicUserIO io) throws InvalidFieldException {
        Long y = BasicParsers.parseLong(
                io,
                "Y: ",
                "Error."
        );
