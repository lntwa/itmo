...
public class AskManager {
    ...
    public static final Logger logger = Logger.getLogger(AskManager.class.getName());
     ...
     */
    public static City askCity(Console console, int id, String login) throws AskBreak {
        try {
            String name;
            while (true) {
            ...
            return new City(id, name, coordinates, LocalDate.now(), area, population, metersAboveSeaLevel, timezone, populationDensity, standardOfLiving, login, governor);
